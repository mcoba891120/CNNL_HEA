...
/home/jhenyu/lammps-stable_2Aug2023_update2/src/lmp_g++_openmpi -var input_file $input_file -var newlx $lx -var newly $ly -var newlz $lz -in in.build_slab
...
#sed  "s/currtemp/300/g" in.slip > tfMC_300K_slip/in.slip
...
#sed  "s/currtemp/1273/g" in.slip > tfMC_1273K_slip/in.slip
