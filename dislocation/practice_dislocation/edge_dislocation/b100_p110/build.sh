...
xc=$(echo $lx*0.5 |bc)
zc=$(echo $lz*0.5+0.5 |bc)
lb=$(echo $lx/48 | bc)

/work/jhenyu/hsieh/atomsk_b0.13.1_Linux-amd64/atomsk POSCAR_modified.data -sub 1 Ni -sub 2 Co -sub 3 Ti -sub 4 Zr -sub 5 Hf -dislocation $zc $xc edge_rm y z $lb 0.0 lmp
