...
def get_dislocation(filename):
    ...
    modifier.trial_circuit_length = 70
...
ase.io.write("dislocation_checking_point5.data",new_atoms,format="lammps-data",specorder=["Ni","Co","Ti","Zr","Hf","Ag","Au"],masses=True)
