...
def get_dislocation(filename):
    ...
    modifier.trial_circuit_length = 60
...
ase.io.write("dislocation_checking_point6.data",new_atoms,format="lammps-data",specorder=["Ni","Co","Ti","Zr","Hf","Ag","Au"],masses=True)
