...
atoms1 = read_lammps_data("HEA_opt_screw1.data",atom_style="atomic",Z_of_type=ztype)
atoms2 = read_lammps_data("HEA_opt_screw2.data",atom_style="atomic",Z_of_type=ztype)
