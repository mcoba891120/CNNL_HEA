...
#SBATCH --job-name=NEB100100          # (-J) Job name
...
mpiexec -np 112 /home/pyyang0519/lammps-stable_29Aug2024_update3/src/lmp_intel_cpu_intelmpi -in in.min > STDOUT1
sed -n "4,4p" final.cfg > final.txt ; sed -n "10,$ p" final.cfg >> final.txt ; rm final.cfg
mpiexec -np 112 /home/pyyang0519/lammps-stable_29Aug2024_update3/src/lmp_intel_cpu_intelmpi -partition 7x16 -in in.neb > STDOUT2
