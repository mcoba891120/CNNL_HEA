...
#SBATCH --job-name=S100110            # (-J) Job name
...
mpiexec -np 112 /home/pyyang0519/lammps-stable_29Aug2024_update3/src/lmp_intel_cpu_intelmpi -partition 14x8 -in in.neb > STDOUT2
