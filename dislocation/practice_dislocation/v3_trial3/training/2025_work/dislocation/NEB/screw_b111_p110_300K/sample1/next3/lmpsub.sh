...
#SBATCH --job-name=S111110            # (-J) Job name
...
mpiexec -np 110 /home/pyyang0519/lammps-stable_29Aug2024_update3/src/lmp_intel_cpu_intelmpi -partition 11x10 -in in.neb > STDOUT2
