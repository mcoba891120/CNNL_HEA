...
input_file="HEA_init_edge.data"

# tfMC_300K_slip
mkdir -p tfMC_300K_new_slip
relax_file="MD_300K_new_relax/after_relax_bulk.data"
...
cp tmp_slab.data tfMC_300K_new_slip/init_slab.data
sed "s/currtemp/300/g" in.relax_slab_manual > tfMC_300K_new_slip/in.relax_slab_manual

# tfMC_1273K_slip
mkdir -p tfMC_1273K_new_slip
relax_file="MD_1273K_new_relax/after_relax_bulk.data"
...
cp tmp_slab.data tfMC_1273K_new_slip/init_slab.data
sed "s/currtemp/1273/g" in.relax_slab_manual > tfMC_1273K_new_slip/in.relax_slab_manual
# tfMC_600K_slip
