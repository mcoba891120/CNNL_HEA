input_file="HEA_init_B2.data"
relax_mode="md"
current_path=$(pwd)
cpu_core=32

mkdir -p ${relax_mode}_300K_slip_ref
...
mv tmp_slab.data ${relax_mode}_300K_slip_ref/init_slab.data
sed  "s/currtemp/300/g" in.relax_slab > ${relax_mode}_300K_slip_ref/in.relax_slab
cd ${relax_mode}_300K_slip_ref
export CUDA_VISIBLE_DEVICES=4
nohup mpirun -np 1 -cpu-set 0 ~/Downloads/lammps-stable_2Aug2023_update3/src/lmp_kokkos_cuda_v100 -k on g 1 -sf kk -pk kokkos newton on neigh half -log none -in in.relax_slab > STDOUT &
...
# cd $current_path
# mkdir -p ${relax_mode}_1273K_slip_ref
...
# mpirun -np 1 /home/cnnltmp01/Downloads/lammps-stable_2Aug2023_update3/src/lmp_kokkos_cuda_v100 -var input_file $input_file -var newlx $lx -var newly $ly -var newlz $lz -in in.build_slab
# #/ceph/work/CNNL/package/lammps-stable_2Aug2023_update3/src/lmp_g++_openmpi -var input_file $input_file -var newlx $lx -var newly $ly -var newlz $lz -in in.build_slab
# mv tmp_slab.data ${relax_mode}_1273K_slip_ref/init_slab.data
# sed  "s/currtemp/1273/g" in.relax_slab > ${relax_mode}_1273K_slip_ref/in.relax_slab
# cd ${relax_mode}_300K_slip_ref
# nohup mpirun -np $cpu_core ~/Downloads/lammps-stable_2Aug2023_update3/src/lmp_kokkos_cuda_v100 -in in.relax_slab > STDOUT &
# ps aux | grep mpirun