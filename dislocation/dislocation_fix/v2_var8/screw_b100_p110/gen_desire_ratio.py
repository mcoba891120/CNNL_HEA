...
atoms = ase.io.read(f"{initial_dir}/POSCAR")
...
ase.io.lammpsdata.write_lammps_data(f"{initial_dir}/HEA_init_B2.data", atoms_curr, specorder=['Ni','Co','Ti','Zr'], units='metal', atom_style='atomic')
