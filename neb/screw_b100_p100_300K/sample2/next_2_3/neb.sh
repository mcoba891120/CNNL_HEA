...
#SBATCH --job-name=screw_b100_p100_300K_neb_sample2_next_2_3          # (-J) Job name
...
mpiexec -np 210 /home/u6710794/lammps-stable_29Aug2024_update3/src/lmp_intel_cpu_intelmpi -partition 7x30 -in in.neb > STDOUT2
