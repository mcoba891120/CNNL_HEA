...
#SBATCH --job-name=edge_b100_p110_300K_min_sample2_next_1_1          # (-J) Job name
...
mpiexec -np 105 /home/u6710794/lammps-stable_29Aug2024_update3/src/lmp_intel_cpu_intelmpi -in in.min > STDOUT1
