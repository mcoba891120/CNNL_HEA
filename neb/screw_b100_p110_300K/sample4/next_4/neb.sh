...
#SBATCH --job-name=screw_b100_p110_300K_neb_sample4_next1          # (-J) Job name
...
mpiexec -np 105 /home/u6710794/lammps-stable_29Aug2024_update3/src/lmp_intel_cpu_intelmpi -partition 7x15 -in in.neb > STDOUT2
