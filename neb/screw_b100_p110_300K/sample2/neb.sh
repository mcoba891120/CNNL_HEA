...
#SBATCH --job-name=edge_b100_p110_300K_neb_sample2          # (-J) Job name
...
mpiexec -np 105 /home/u6710794/lammps-stable_29Aug2024_update3/src/lmp_intel_cpu_intelmpi -partition 21x5 -in in.neb > STDOUT2
