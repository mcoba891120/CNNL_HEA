...
def analyze_nearest_neighbors(filename, num_neighbors=8, output_csv="neighbor_analysis.csv"):
    ...
    unique_symbols = list(atoms.get_chemical_symbols())


    atoms.set_chemical_symbols(unique_symbols)
...
# 使用示例
analyze_nearest_neighbors("relaxation/NiCoTiZrHf_111/structure/NiCoTiZrHf_69120.lmp", num_neighbors=8)
