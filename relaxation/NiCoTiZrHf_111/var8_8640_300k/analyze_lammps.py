...
def analyze_nearest_neighbors(filename, num_neighbors=8, output_csv="neighbor_analysis_before_relax.csv"):
...
# 使用示例
analyze_nearest_neighbors("relaxation/NiCoTiZrHf_111/var8_8640_300k/NiCoTiZrHf_8640.lmp", num_neighbors=8)
