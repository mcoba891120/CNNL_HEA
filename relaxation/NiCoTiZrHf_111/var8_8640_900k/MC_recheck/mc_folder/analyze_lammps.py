...
output_path="relaxation/NiCoTiZrHf_111/var8_8640_900k/MC_recheck/neighbor_analysis.csv"

def analyze_nearest_neighbors(filename, num_neighbors=8, output_csv=output_path):
...
# 使用示例
analyze_nearest_neighbors("relaxation/NiCoTiZrHf_111/var8_8640_900k/MC_recheck/mc_folder/emin.data", num_neighbors=8)
